...
use Mavericks\NovaNestedForm\Exceptions\NestedValidationException;
use Mavericks\NovaNestedForm\Requests\CustomCreateResourceRequest;
use Mavericks\NovaNestedForm\Requests\CustomUpdateResourceRequest;
use Mavericks\NovaNestedForm\Requests\CustomDeleteResourceRequest;
...
trait FillsSubAttributes
{
    ...
    /**
     * This method returns the right request for the given data.
     *
     * @param array $data
     * @param Model $model
     * @param string $attribute
